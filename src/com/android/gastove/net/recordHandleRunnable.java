...
public class recordHandleRunnable implements Runnable {
	...
	public recordHandleRunnable(Context con, String count, ProgressDialog pDialog) {
		progressDialog = pDialog;
		context = con;
		tableCount  = count;
	}
	
	public recordHandleRunnable(Context con, String count) {
//		progressDialog = pDialog;
		context = con;
		tableCount  = count;
	}
...
//		pupwincontentRunnalbe();
		...
		recordtodayindexRunnalbe(count[0]);
		recordtodayRunnalbe(count[1]);
		recordinRunnalbe(count[2]);
