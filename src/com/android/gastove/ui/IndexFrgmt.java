...
public class IndexFrgmt extends Fragment {
	...
	private static IndexFrgmt mIndexFrgmt;
	 ...
	 * @return
	 */
	public static IndexFrgmt getInstance() {
		if (mIndexFrgmt == null) {
			mIndexFrgmt = new IndexFrgmt();
		}
		return mIndexFrgmt;
	}

	public void destoryFrgmt() {
		mIndexFrgmt = null;
	}
	...
	private static final class QueryHandler extends AsyncQueryHandler {
		private final WeakReference<IndexFrgmt> mIndexFrgmt;
		...
		public QueryHandler(Fragment context) {
			...
			mIndexFrgmt = new WeakReference<IndexFrgmt>((IndexFrgmt) context);
		}

		@Override
		protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
			final IndexFrgmt frgmt = mIndexFrgmt.get();
			if (frgmt != null && !frgmt.isDetached()) {
				final IndexFrgmt.RecentCallsAdapter callsAdapter = frgmt.mAdapter;
	...
	final class RecentCallsAdapter extends GroupingListAdapter implements
		...
		protected View newStandAloneView(Context context, ViewGroup parent) {
			...
			View view = inflater.inflate(R.layout.tab_frgmt_index_list_item,
					parent, false);
		...
		private void findAndCacheViews(View view) {
			...
			views.callView = (ImageView) view
					.findViewById(R.id.img_caller_icon);
//			views.callView
//					.setBackgroundResource(R.drawable.ic_tab_unselected_friends_list);
			view.setTag(views);
		}
