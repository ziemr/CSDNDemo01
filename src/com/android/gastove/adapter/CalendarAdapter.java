package com.android.gastove.adapter;
...
import com.android.gastove.calendar.LunarCalendar;
import com.android.gastove.calendar.SpecialCalendar;


public class CalendarAdapter extends BaseAdapter {

	 private boolean isLeapyear = false;  //是否  年
	 private int daysOfMonth = 0;      //某月的天数
	 private int dayOfWeek = 0;        //具体某一天是星期几
	 private int lastDaysOfMonth = 0;  //上一个月的 天数
	 private Context context;
	 private String[] dayNumber = new String[42];  //一个gridview中的日期存入此数 中
	// private static String week[] = {"周日","周一","周二","周三","周四","周五","周六"};
	 ...
	 public CalendarAdapter(Context context,Resources rs,int jumpMonth,int jumpYear,int year_c,int month_c,int day_c){
	  ...
	  currentMonth = String.valueOf(stepMonth);  //得到本月 （jumpMonth 滑动的次数，每滑动一次就增加一月或减一月）
