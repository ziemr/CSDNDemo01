...
public class ContactListItemView extends ViewGroup {
    ...
    private static final int QUICK_CONTACT_BADGE_STYLE = 13;
//            com.android.internal.R.attr.quickContactBadgeStyleWindowMedium;

    private final Context mContext;

    private final int mPreferredHeight = 50;
    ...
    private DontPressWithParentTextView mCallButton;
...
//        a.recycle();
    ...
    private void ensureHorizontalDivider() {
        if (mHorizontalDividerDrawable == null) {
            mHorizontalDividerDrawable = mContext.getResources().getDrawable(R.drawable.divider_vertical_dark);
